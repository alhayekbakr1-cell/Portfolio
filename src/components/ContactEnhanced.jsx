...
const ContactEnhanced = () => {
    ...
    const styles = {
        ...
        field: { padding: '13px 16px', fontSize: '1rem', border: '2px solid var(--border-color)', borderRadius: '12px', fontFamily: 'inherit', background: 'rgba(255,255,255,0.95)', color: 'var(--text-primary)' },
        textarea: { padding: '13px 16px', fontSize: '1rem', border: '2px solid var(--border-color)', borderRadius: '12px', minHeight: '150px', resize: 'vertical', fontFamily: 'inherit', background: 'rgba(255,255,255,0.95)', color: 'var(--text-primary)' },
        ...
        <>
            ...
            <section id="contact" style={styles.section}>
                <div style={styles.wrapper}>
                    ...
                    <motion.div style={styles.formCard} {...reveal} transition={{ ...reveal.transition, delay: 0.1 }}>
